...
<script type="text/javascript">
    ...
    <table align="center" id="p" class="easyui-panel" title="글상세보기" data-options="footer:'#tb_read'"
        style="width:670px;height:380px;padding:10px;background:#fafafa;">
	    	...
	    	<tr>
	    	<td>작성자</td>
	    	<td><input id="bm_writer" value="<%=rbm_writer%>" name="bm_write" class="easyui-textbox"></td>
	    	</tr>
	    	<tr>
	    	<td>이메일</td>
...
MultipartRequest  => cos.jar
 -->	
	...
	<input type="hidden" name="bm_pos" value="<%=rbm_tos%>">
	...
	<table>
		...
		<tr>	
			...
			<td width="500px">
				<input class="easyui-textbox" data-options="width:'150px'" id="bm_writer" name="bm_write" required>
			</td>
		</tr>
		<tr>
