...
<html>
 <head>
  ...
  <script type="text/javascript">
  	function insert(){
  		cmm_window_popup('addSch.jsp','400','500','addSch');

  	}
  	function getSchedule(){
  		var names=$("#sp").text();
  		cmm_window_popup('getSch.jsp?names='+names,'400','500','getSch');
  	}
  </script>
 </head>
 <body>
	<div><font size=20>개발팀</font></div>
  <%
  ...
  <table border=1 cellspacing=0> <!-- 달력 부분 -->
   ...
   //디비에서 조회온 값을 가져왔을 때.
    if(year==2020 && month+1==6 && i==2) {
        ...
        out.println("<div style='background-color:#0100FF;' onClick='javascript:getSchedule()'><span id='sp'>"+"테스트"+"</span></div>"); 
       }
    out.println("</td>");
    br++;
    if((br%7)==0 && i!=end) {
